...
@property (nonatomic, strong) UIImageView *resultIconImageView;
...
#pragma clang diagnostic pop
        ...
        _resultIconImageView = [[UIImageView alloc] init];
        ...
        _resultIconImageView.frame = CGRectMake((self.windowWidth - kResultIconWitdh)/2, kTitleTop + kTitleHeight + 30, kResultIconWitdh, kResultIconWitdh);
        _resultIconImageView.image = [UIImage imageNamed:@"popup_onay_icon"];
        [_contentView addSubview:_resultIconImageView];
...
- (void)viewWillLayoutSubviews
{
    ...
    
    {
        ...
        CGRect resultIconFrame = _resultIconImageView.frame;
        resultIconFrame.origin.y = y;
        [_resultIconImageView setFrame:resultIconFrame];
        
        y += _resultIconImageView.frame.size.height + 14.0f;
...
-(SCLAlertViewResponder *)showTitle:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    switch (style)
    {
        ...
        case Warning_Deniz_Pos:
            viewColor = UIColorFromHEX(0x0A5499);
            iconImage = image;
            self.circleIconHeight *= 2.0f;
            break;
    }
...
{
    [self showTitle:vc image:nil color:nil title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Warning_Style];
}
...
- (void)showInfo:(UIViewController *)vc title:(NSString *)title subTitle:(NSString *)subTitle withCustomImage:(UIImage*)withCustomImage closeButtonTitle:(NSString *)closeButtonTitle duration:(NSTimeInterval)duration
{
    [self showTitle:vc image:withCustomImage color:nil title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Warning_Deniz_Pos];
}
...
{
    [self showTitle:nil image:nil color:nil title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Warning_Style];
}
