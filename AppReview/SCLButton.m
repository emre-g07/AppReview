...
- (void)setup
{
    self.frame = CGRectMake(0.0f, 0.0f, 216.0f, 45.0f);
}
...
- (UIColor *)darkerColorForColor:(UIColor *)color
{
    ...
    return [UIColor colorWithRed:10.0f/255.0f green:84.0f/255.0f blue:153.0f/255.0f alpha:1.0f];
    /*
     CGFloat r = 10, g = 84, b = 153, a = 1;
